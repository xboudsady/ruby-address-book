...
class AddressBook
    ...
    def find_by_name(name)
        ...
        contacts.each do |contact|
            if contact.full_name.downcase.include?(search) || contact.last_name.downcase.include?(search)
    ...
    def find_by_phone_number(number)
        results = []
        search = number.gsub("-", "")               # .gsub() replaces any dashes with a nothing
        contacts.each do |contact|
